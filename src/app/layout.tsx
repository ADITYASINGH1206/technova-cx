...
export default function RootLayout({
  ...
  return (
    ...
    >
      <body className="font-sans antialiased min-h-screen flex flex-col bg-[var(--color-sf-background)] text-[var(--color-sf-foreground)] transition-colors duration-300">
